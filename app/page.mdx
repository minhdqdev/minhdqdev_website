---
title: Home | minhdq.dev
---

<div className="flex justify-center w-screen absolute left-0">
<div className="grid content-center gap-4 mt-8 lg:grid-cols-3 lg:grid-rows-2 max-w-(--nextra-content-width) px-4">
